...
public abstract class ServerCnxn implements Stats, Watcher {
    ...
    protected final AtomicLong packetsReceived = new AtomicLong();// 接收的packet数量
    protected final AtomicLong packetsSent = new AtomicLong();// 发送的packet数量

    protected long minLatency;// 最小延迟
    protected long maxLatency;// 最大延迟
    protected String lastOp;// 最后操作类型
    protected long lastCxid;// 最后的cxid
    protected long lastZxid;// 最后的zxid
    protected long lastResponseTime;// 最后的响应时间
    protected long lastLatency;// 最后的延迟

    protected long count;// 数量
    protected long totalLatency;// 总的延迟
